...
#ej21 td:nth-child(2){
	...
	<body>
		...
		<?php
			...
			$suma=$num1 + $num2;			
			echo "La suma de 6 y 3 es $suma <br>";

			$multiplicacion=multiplicacion(6,3);
			echo "La multiplicacion es " .$multiplicacion;

			include 'division.php'; //llama a otro archivo
			echo "<br>";
			// echo division();
		...
		<?php			
            ...
            echo "EL número aleatorio que te damos es: $aleatorio <br>";

			if($aleatorio<50)
			{
				echo "El número " .$aleatorio." es MENOR que 50";
			} 
			
			else if($aleatorio>50){
				echo "El número " .$aleatorio. " es MAYOR que 50";

            }else{
                echo "El número " .$aleatorio. " es IGUAL que 50";
            }			
		?>
		...
		*/
		...
		//array indexado (indice 0 1 2 3 4 )
            ...
            foreach($supermercado as $indice=>$valor){
				echo "<ul>" .$indice ; //imprimir el índice porque es un array indexado
